...
status: not-loopable
created: 2026-06-01
working_title: test-fixture-bad-not-loopable-converge
blockers: []
tags:
  - type/goal-charter
  - domain/tooling
...
# Goal charter — test-fixture-bad-not-loopable-converge

Defect: Status is `not-loopable` but section 8 circles **converge**, which is a
looping executor and is forbidden when not-loopable is set.
...
Note: this goal is marked not-loopable because no checkable bar can be stated NOW.
...
**converge** — loop until the bar is met (WRONG: not-loopable forbids this).
