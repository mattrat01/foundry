...
status: dispatched
created: 2026-06-01
working_title: test-fixture-bad-pending-verdict
blockers: []
tags:
  - type/goal-charter
  - domain/tooling
...
# Goal charter — test-fixture-bad-pending-verdict

Defect: Status is `dispatched` (past blocked) but the step-7 verdict line still says
"pending" — state-consistency check 10.
...
> Verdict (verbatim, attributed — goal-skeptic, 2026-06-01): **pending** — awaiting dispatch.
