...
status: dispatched
created: 2026-06-01
working_title: test-fixture-bad-placeholder
blockers: []
tags:
  - type/goal-charter
  - domain/tooling
...
# Goal charter — test-fixture-bad-placeholder

Defect: A {{placeholder}} was left unfilled in section 1.
...
So {{some-unfilled-placeholder}} commits are caught before they reach main.
