...
status: dispatched
created: 2026-06-01
working_title: test-fixture-bad-guidance-block
blockers: []
tags:
  - type/goal-charter
  - domain/tooling
...
# Goal charter — test-fixture-bad-guidance-block

> COPY THIS FILE, fill the sections top-to-bottom, delete this guidance block, then
> hand the finished charter to an executor. This block should have been deleted.

Defect: The template guidance block ("> COPY THIS FILE") was not deleted.
