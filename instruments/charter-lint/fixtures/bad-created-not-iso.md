...
status: dispatched
created: 1 June 2026
working_title: test-fixture-bad-created-not-iso
blockers: []
tags:
  - type/goal-charter
  - domain/tooling
...
# Goal charter — test-fixture-bad-created-not-iso

Defect: `created` is a human-readable date string, not ISO YYYY-MM-DD.
