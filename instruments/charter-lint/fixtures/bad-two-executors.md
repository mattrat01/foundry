...
status: dispatched
created: 2026-06-01
working_title: test-fixture-bad-two-executors
blockers: []
tags:
  - type/goal-charter
  - domain/tooling
...
# Goal charter — test-fixture-bad-two-executors

Defect: Section 8 circles two executors (**delegate** and **converge**) instead of one.
...
**delegate** — first pass to build the script.

**converge** — loop until the bar is met.
